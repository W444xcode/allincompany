...
$(function () {
  ...
  if (bgndKenburns.length) {
    bgndKenburns.vegas({
      ...
      slides: [{ src: 'img/backgrounds/960x1440-bg-kenburns-1.jpg' }, { src: 'img/backgrounds/960x1440-bg-kenburns-2.jpg' }, { src: 'img/backgrounds/960x1440-bg-kenburns-3.jpg' }],
  ...
  $('#notif').submit(function () {
    //Change
    var th = $(this);
    $.ajax({
      type: 'POST',
      url: '../php/subscribe.php', //Change
      data: th.serialize(),
    }).done(function () {
      $('#notify-form').find('.form').addClass('is-hidden');
      $('#notify-form').find('.reply-group').addClass('is-visible');
      setTimeout(function () {
        // Done Functions
        $('#notify-form').find('.reply-group').removeClass('is-visible');
        $('#notify-form').find('.form').delay(300).removeClass('is-hidden');
        th.trigger('reset');
      }, 5000);
    });
    return false;
  ...
  // --------------------------------------------- //
  // Mailchimp Notify Form End  notify-form
  // --------------------------------------------- //
